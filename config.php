<?php
	...
	$config['site_title'] = 'Your Server Title';
	...
	$config['server_path'] = 'C:/Users/domen/OneDrive/Escritorio/servidor/otbr-global-v1.2.0-ubuntu-20.04-server+exe/';
	...
	$config['sqlUser'] = 'domenico';

	// phpmyadmin password for OT server:
	$config['sqlPassword'] = 'Domenico123.';

	// The database name to connect to. (This is usually same as username).
	$config['sqlDatabase'] = 'otbr';
	...
	*/
	...
	$config['client'] = 1264; // 954 = client 9.54
	...
	$config['gameserver'] = array(
		'ip' => '127.0.0.1',
		'port' => 7172,
		'name' => 'otbr' // Must be identical to config.lua (OT config file) server name.
	);
